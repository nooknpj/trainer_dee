  ...
  async fetchUpdateRating() {
    try {
      const data = {
        ...
        rating:
          (this.state.rating + this.props.rating * this.props.rateCount) /
          parseFloat(this.props.rateCount + 1),
        trainerID: this.props.trainerID,
        rateCount: this.props.rateCount + 1
      };
  ...
  render() {
    return (
      <div>
        <Link
          to={{
            pathname: `/courseDesc/${this.props.courseID}`,
            state: this.props.courseID
          }}
        ...
        <Modal show={this.state.showRate} onHide={this.onRateSuccess}>
          <Modal.Header closeButton>
            <Modal.Title>
              Rate Trainer {this.props.fName} {this.props.lName}
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
